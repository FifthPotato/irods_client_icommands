...
/*
    char *llqMsgs[] = {
        " llq [CollName] List Logical Quotas",
        "List all quotas that have been set (if any).",
        "If CollName is provided, list only logical quotas set on that collection.",
        "Also see clu, and slq.",
        ""
    };
*/
